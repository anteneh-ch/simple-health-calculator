...
document.getElementById('dose-calc').addEventListener('click', () => {
  ...
  document.getElementById('dose-units').textContent = `= ${units.toFixed(2)} unit(s) at ${strength} mg each`;
...
document.getElementById('hr-calc').addEventListener('click', () => {
  ...
  const zoneRanges = [[0.50,0.60],[0.60,0.70],[0.70,0.80],[0.80,0.90],[0.90,1.00]];
